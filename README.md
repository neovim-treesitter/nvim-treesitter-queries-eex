# nvim-treesitter-queries-eex

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-eex/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-eex/actions/workflows/validate.yml)

Neovim tree-sitter queries for **eex**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-eex",
...
- [ ] Changes are scoped to `eex` — do not include files for other languages
